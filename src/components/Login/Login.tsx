...
function Login() {
  ...
  const Icon = {
    backgroundImage: "url('./static/images/Icons/Icon-face.png')",
  }
  const google = {
    backgroundImage: "url('./static/images/Icons/google.png')",
  }
  const facebook = {
    backgroundImage: "url('./static/images/Icons/facebook.png')",
  }
  return (
    <div>
